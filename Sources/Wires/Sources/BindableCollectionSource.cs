namespace Wires
{
	...
	public class BindableCollectionSource<TOwner,TSection, TItem, TView, TCellView, THeaderCellView> : BindableCollectionSource<TOwner, Collection<TSection,TItem>, TSection, TItem, TView, TCellView, THeaderCellView>
		where TOwner : class
		where TView : class
	{
		public BindableCollectionSource(TOwner source, Expression<Func<TOwner, Collection<TSection, TItem>>> sourceProperty, TView view, Action<TView> triggerReloading, Action<TItem, Index, TCellView> prepareCell = null, Action<TSection, int, THeaderCellView> prepareHeader = null, ICommand selectCommand = null) : base(source, sourceProperty, ((a, i) => a[i].Key), ((a) => a.Count), ((a, i) => a[i].Count), ((a, i) => a[i.Section][i.Item]), view, triggerReloading, prepareCell, prepareHeader, selectCommand){ }
	}

	public class BindableCollectionSource<TOwner, TCollection, TSection, TItem, TView, TCellView, THeaderCellView>
		where TOwner : class
		where TView : class
